...
const ShiatsuSticker = () => {
  return (
    <div><div className='new-offer shiatsu-offer'>
    <motion.div
      className="offer-box shiatsu-box"
      initial={{ x: 150, opacity: 0 }}
      animate={{ x: 0, opacity: 1 }}
      transition={{ type: "spring", stiffness: 70, damping: 15, delay: 1 }}
      onClick={() => {
        const section = document.getElementById("shiatsu-kurs");
        if (section) {
    ...
    >
      ...
      <p>
        ...
        <em>Fr. 7.11. & 14.11.25 · 17.30-19.30 Uhr</em><br />
        <strong>60 €</strong>
      </p>
    </motion.div>
  </div>
